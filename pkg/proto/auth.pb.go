...
func (x *RegisterResponse) SetDeviceId(v string) {
...
func (x *RegisterResponse) HasDeviceId() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 2)
...
func (x *RegisterResponse) ClearDeviceId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
...
func (x *LoginResponse) SetDeviceId(v string) {
	x.xxx_hidden_DeviceId = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 2, 3)
}
...
func (x *LoginResponse) HasDeviceId() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 2)
...
func (x *LoginResponse) ClearDeviceId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_DeviceId = nil
}
...
const file_auth_proto_rawDesc = "" +
	...
	"\x14encrypted_master_key\x18\x02 \x01(\fR\x12encryptedMasterKey\x12\x1b\n" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token\x120\n" +
	"\x14encrypted_master_key\x18\x02 \x01(\fR\x12encryptedMasterKey\x12\x1b\n" +
	"\tdevice_id\x18\x03 \x01(\tR\bdeviceId2\x92\x01\n" +
	"\vAuthService\x12E\n" +
