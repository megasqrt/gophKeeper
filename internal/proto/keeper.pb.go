...
const file_internal_proto_keeper_proto_rawDesc = "" +
	...
	"\rKeeperService\x12;\n" +
	"\bRegister\x12\x16.proto.RegisterRequest\x1a\x17.proto.RegisterResponseB\x1bZ\x19gophKeeper/internal/protob\beditionsp\xe8\a"

var file_internal_proto_keeper_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_internal_proto_keeper_proto_depIdxs = []int32{
	0, // 0: proto.KeeperService.Register:input_type -> proto.RegisterRequest
	1, // 1: proto.KeeperService.Register:output_type -> proto.RegisterResponse
